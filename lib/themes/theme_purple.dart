...
class PurpleTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff85656a),
      ...
      secondaryFixed: Color(0xff85656a),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff6b4d52),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff452b30),
      onSecondaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      secondaryContainer: Color(0xffe0b9bf),
      ...
      secondaryFixedDim: Color(0xffe4bdc2),
      onSecondaryFixedVariant: Color(0xff1f0b0f),
      tertiaryFixed: Color(0xffffdcbb),
